        ...
        children: [
          ...
          Expanded(
            child: provider.isLoading
                ...
                : RefreshIndicator(
                    onRefresh: () => context.read<PapersProvider>().loadPapers(),
                    child: ListView.separated(
                      ...
                      itemBuilder: (itemContext, index) {
                        ...
                        return ListTile(
                          title: Text(title),
                          subtitle: Text((paper is Map ? (paper['year']?.toString() ?? '') : '')), 
                          trailing: const Icon(Icons.chevron_right),
                          onTap: () async {
                            // Use provider captured from the State's context and navigate with the State's context
