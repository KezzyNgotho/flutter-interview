                          ...
                          return Card(
                            child: InkWell(
                              onTap: () {
                                ...
                                setState(() {
                                  // Expand/collapse this specific question
                                  // Maintain a set on State using a dynamic property via map on State object
                                  final expanded = (context as Element).findAncestorStateOfType<_PaperDetailScreenState>()!;
                                });
                              },
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Expanded(child: Text('$idx. $questionText')),
